...
// export async function getSrgMappings(mcVersion: string, filter: MappingsFilter.ts): Promise<Mappings> {
...
//
//
// function loadSRGMappings(srgVersion: SRGVersion, srg_mappings: string, filter: MappingsFilter.ts): Mappings {
...
// function loadSRG1Mappings(rawMappings: string, filter: MappingsFilter.ts): Mappings {
...
// }
//
//  function loadTSRG1Mappings(mappings: string,filter: MappingsFilter.ts): Mappings {
//     const builder = new MappingsBuilder(filter);
