...
export function javaClassFullName(javaClass: JavaClass): string {
    return javaClass.packageName + "." + javaClass.simpleName;
}

export function javaMethodSimpleName(javaMethod: JavaMethod): string {
    return javaMethod.class.simpleName + "." + javaMethod.name;
}

export function javaMethodFullNameName(javaMethod: JavaMethod): string {
