...
var testRichStackTrace = {
    ...
    stackTrace: {
        title: {
            ...
            class: Mappable_1.JavaClass.dotSeperatedObject({
        ...
        elements: [
            {
                ...
                method: Mappable_1.JavaMethod.dotSeperatedObject({
                    name: "wrapSink",
                    classIn: {
        ...
        causedBy: {
            title: {
                ...
                class: Mappable_1.JavaClass.dotSeperatedObject({ packageName: "java.lang", simpleName: "UberCrasher" })
            },
            elements: [
                {
                    forgeMetadata: {
            ...
            causedBy: {
                title: {
                    ...
                    class: Mappable_1.JavaClass.dotSeperatedObject({ packageName: "java.lang", simpleName: "UberSuperCrasher" })
                },
                elements: [
                    {
                        forgeMetadata: {
